...
d2js 原型实际上 2007 年即已出现并实用了多年，当时原理是前端的 ado.net，后端的 ado dataadapter，已经包括了 render-collect等机制（区别于灵敏绑定），后台使用 DSL->Java 带有契约式编程风格，限于为原公司成果，此处不多介绍，当时取代的是 struts2 框架。
