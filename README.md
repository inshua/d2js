...
注意，题目有点哗众取宠，d2js 原型实际上 2007 年即已出现并实用了多年，当时原理是前端的 ado.net，后端的 ado dataadapter，早于市面上常见的各种框架，到现在也是独立生长的。 这3个框架之间具有可分可合、既互相扶持又能独立作战的生态，并不是为了与市面上的各个框架竞争而发明的，也没有受过它们任何思想启发。
